...
// Code is generated on: 11/07/2022 10:46:34
//
...
namespace GamestartLogicContext
{
    ...
    public partial class Abbonamento : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<Promozione> _Promozione;
        ...
        public Abbonamento()
        {
            ...
            this._Promozione = new EntitySet<Promozione>(new Action<Promozione>(this.attach_Promozione), new Action<Promozione>(this.detach_Promozione));
            OnCreated();
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Abbonamento_Promozione", Storage="_Promozione", ThisKey="IdAbbonamento", OtherKey="IdPromozione", LinkTableName=@"gamestart_logic.offerta", LinkThisKey=@"IdAbbonamento", LinkOtherKey=@"IdPromozione")]
        public EntitySet<Promozione> Promozione
        {
            get
            {
                return this._Promozione;
            }
            set
            {
                this._Promozione.Assign(value);
            }
        }
        ...
        private void attach_Promozione(Promozione entity)
        {
            this.SendPropertyChanging("Promozione");
            entity.Abbonamento.Add(this);
        }
    
        private void detach_Promozione(Promozione entity)
        {
            this.SendPropertyChanging("Promozione");
            entity.Abbonamento.Remove(this);
        }
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._Prodotto.HasLoadedOrAssignedValue == false))
                {
                    ...
                    if (previousValue != null)
                    {
                        ...
                        previousValue.Dettaglivendita = null;
                    }
                    this._Prodotto.Entity = value;
                    if (value != null)
                    {
                        this._IdProdotto = value.IdProdotto;
                        value.Dettaglivendita = this;
                    }
                    else
                    {
    ...
    public partial class Preordine : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_IdPreordine", CanBeNull = false, DbType = "BIGINT NOT NULL", IsPrimaryKey = true)]
    ...
    public partial class Prodotto : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<Dettaglivendita> _Dettaglivendita;
        ...
        public Prodotto()
        {
            this._Dettaglivendita  = default(EntityRef<Dettaglivendita>);
            this._Preordine = new EntitySet<Preordine>(new Action<Preordine>(this.attach_Preordine), new Action<Preordine>(this.detach_Preordine));
            OnCreated();
        }
        ...
        public long IdProdotto
        {
            ...
            set
            {
                if (this._IdProdotto != value)
                {
                    if (this._Dettaglivendita.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        /// There are no comments for Dettaglivendita in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Prodotto_Dettaglivendita", Storage="_Dettaglivendita", ThisKey="IdProdotto", OtherKey="IdProdotto", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
        public Dettaglivendita Dettaglivendita
        {
            get
            {
                return this._Dettaglivendita.Entity;
            }
            set
            {
                Dettaglivendita previousValue = this._Dettaglivendita.Entity;
                if ((previousValue != value) || (this._Dettaglivendita.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("Dettaglivendita");
                    if (previousValue != null)
                    {
                        this._Dettaglivendita.Entity = null;
                        previousValue.Prodotto = null;
                    }
                    this._Dettaglivendita.Entity = value;
                    if (value != null)
                    {
                        value.Prodotto = this;
                    }
                    this.SendPropertyChanged("Dettaglivendita");
                }
            }
        }
    ...
    public partial class Promozione : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for Abbonamento in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Abbonamento_Promozione", Storage="_Abbonamento", ThisKey="IdPromozione", OtherKey="IdAbbonamento", LinkTableName=@"gamestart_logic.offerta", LinkThisKey=@"IdPromozione", LinkOtherKey=@"IdAbbonamento")]
        public EntitySet<Abbonamento> Abbonamento
        {
            get
            {
        ...
        {
            this.SendPropertyChanging("Abbonamento");
            entity.Promozione.Add(this);
        }
    
        private void detach_Abbonamento(Abbonamento entity)
        {
            this.SendPropertyChanging("Abbonamento");
            entity.Promozione.Remove(this);
        }
    }
